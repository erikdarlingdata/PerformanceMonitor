...
internal static class McpInstructions
{
    public const string Text = """
        ...
        | `get_query_store_top` | Expensive queries from Query Store (persistent), including module_name; optional exact module filter is applied before ranking | `server_name`, `hours_back`, `top`, `database_name`, `as_of`, `module_name` |
