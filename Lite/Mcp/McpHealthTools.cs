...
public sealed class McpHealthTools
{
    ...
    /// <summary>#4198, matching Darling's twin exactly: error_message is this tool's one wide field, previewed
    /// to this length per row at default (full_text: true opts back in).</summary>
