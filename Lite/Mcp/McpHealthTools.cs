        ...
        try
        {
            ...
            return JsonSerializer.Serialize(new
            {
                ...
                */
                ...
                min_duration_ms,
                /* #3869: echoed in the STORED spelling rather than the caller's, like Darling's twin, because
                   the filter matched case-insensitively and a page echoing "error" beside rows whose status
                   field reads "ERROR" would invite a client to conclude the filter had not applied. */
