...
BEGIN
    ...
    BEGIN TRY
        ...
        */
        ...
        WHERE xss.collector_name = N'blocked_process_xml_collector';
        ...
        */
        ...
        BEGIN
            IF EXISTS (SELECT 1/0 FROM config.xe_shred_state WHERE collector_name = N'blocked_process_xml_collector')
            BEGIN
                UPDATE
                ...
                WHERE collector_name = N'blocked_process_xml_collector';
            END;
            ELSE
            BEGIN
                INSERT INTO
