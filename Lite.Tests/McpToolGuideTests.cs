...
/// a caller needs to read the answer is served in the HEAD, not left in the guide. Darling's twin is
/// <c>Darling.Tests/McpToolGuideTests</c>, which also holds the cross-SKU lockstep pins (identical heads, identical
/// guide tool), because that project already reads Lite's source.
/// </summary>
