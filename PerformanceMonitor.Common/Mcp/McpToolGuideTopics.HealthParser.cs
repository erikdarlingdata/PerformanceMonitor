...
/// <summary>The health-parser family's topics (#3898 D1 pilot). See <see cref="McpToolGuideTopics"/>'s class
/// doc comment for the partial-file pattern every other family copies.</summary>
public static partial class McpToolGuideTopics
{
    ...
    private static readonly McpToolGuideTopic[] s_healthParser =
    [
        new(
