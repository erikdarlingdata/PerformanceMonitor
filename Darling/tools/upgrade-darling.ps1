...
Note "  2. COUNT(DISTINCT server_id) FROM collect.collection_log over the last 15 minutes equals the fleet size plus the '(fleet)' maintenance row - the retention sweep logs under server_id = 0."
