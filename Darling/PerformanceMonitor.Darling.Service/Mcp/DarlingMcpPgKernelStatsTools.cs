...
public sealed class DarlingMcpPgKernelStatsTools
{
    ...
    public static async Task<string> GetPgKernelStats(
        ...
        [Description("Maximum query shapes to return, most CPU first. Default 20. This is what bounds the page - read truncated to know whether the window held more; the shares stay of the whole window whatever this is set to.")] int limit = 20,
