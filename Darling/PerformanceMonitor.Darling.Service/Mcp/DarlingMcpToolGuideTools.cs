...
/// Lite's <c>McpToolGuideTools</c> is the twin, same name, same description, same topics (D6 lockstep). It reads
/// no store data and no monitored server: the catalog is built at registration from the tools this host serves.
/// </summary>
[McpServerToolType]
