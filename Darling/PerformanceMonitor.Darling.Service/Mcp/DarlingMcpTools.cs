...
public sealed class DarlingMcpTools
{
    ...
    internal const string FactSourceFilterDescription =
        ...
        + "anomaly, bad_actor, blocking, config, coverage, cpu, database_config, disk, io, jobs, memory, pg_bloat, pg_buffer, pg_config, pg_cpu, pg_database, pg_io, pg_posture, pg_queries, pg_replication, pg_sessions, pg_temp, pg_vacuum, pg_waits, pg_write, queries, sessions, tempdb, waits. "
