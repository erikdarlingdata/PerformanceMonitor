...
public sealed class DarlingObservabilityTests
{
    ...
    public async Task EndToEnd_UpsertServerAndLogCollection_AgainstDevPostgres()
    {
        ...
        await DarlingObservability.LogCollectionAsync(
            postgres, server, "wait_stats", "SUCCESS", 42, 100, 25, null, fanout: null, phases: null, null, TestContext.Current.CancellationToken);
        ...
        await DarlingObservability.LogCollectionAsync(
            ...
            new FanoutCost(8, "the-busy-one", 61_900), phases: null, null, TestContext.Current.CancellationToken);
    ...
    public async Task CollectionHealth_ReportsTheFanoutRollup_AgainstDevPostgres()
    {
        ...
        await DarlingObservability.LogCollectionAsync(
            postgres, server, "query_store", "SUCCESS", 900, 70_000, 10_800, null,
            new FanoutCost(8, "even-worst", 10_100), phases: null, null, TestContext.Current.CancellationToken);
        ...
        await DarlingObservability.LogCollectionAsync(
            ...
            fanout: null, phases: null, null, TestContext.Current.CancellationToken);
