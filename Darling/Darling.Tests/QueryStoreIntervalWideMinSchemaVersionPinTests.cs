...
/// <see cref="StorageVersion.SchemaVersion"/> instead of probing the store), and the viewer's grid top
/// read (its own constant, since it lives in <see cref="ViewerDataService"/> and gates on the identical
