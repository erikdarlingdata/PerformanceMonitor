...
CREATE TABLE IF NOT EXISTS pg_server_config (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_server_config_time ON pg_server_config(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_deadlocks (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_deadlocks_time ON pg_deadlocks(server_id, collection_time);
...
CREATE TABLE IF NOT EXISTS pg_database_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_database_stats_time ON pg_database_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_index_usage_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_index_usage_stats_time ON pg_index_usage_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_table_bloat_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_table_bloat_stats_time ON pg_table_bloat_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_session_states (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_session_states_time ON pg_session_states(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_plan_capture_readiness (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_plan_capture_readiness_time ON pg_plan_capture_readiness(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_write_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_write_stats_time ON pg_write_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_extension_availability (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_extension_availability_time ON pg_extension_availability(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_lock_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_lock_stats_time ON pg_lock_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_wait_sampling (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_wait_sampling_time ON pg_wait_sampling(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_kernel_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_kernel_stats_time ON pg_kernel_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_predicate_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_predicate_stats_time ON pg_predicate_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_plan_capture (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_plan_capture_time ON pg_plan_capture(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_column_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_column_stats_time ON pg_column_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_replication_stats (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_replication_stats_time ON pg_replication_stats(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_buffer_usage (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_buffer_usage_time ON pg_buffer_usage(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_index_bloat (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_index_bloat_time ON pg_index_bloat(server_id, collection_time);

CREATE TABLE IF NOT EXISTS pg_cpu_utilization (
    collection_id bigint NOT NULL,
    collection_time timestamp NOT NULL,
    server_id integer NOT NULL,
    server_name text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pg_cpu_utilization_time ON pg_cpu_utilization(server_id, collection_time);
...
ALTER TABLE IF EXISTS public.pg_server_config SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_deadlocks SET SCHEMA collect;
...
ALTER TABLE IF EXISTS public.pg_database_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_index_usage_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_table_bloat_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_session_states SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_plan_capture_readiness SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_write_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_extension_availability SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_lock_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_wait_sampling SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_kernel_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_predicate_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_plan_capture SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_column_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_replication_stats SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_buffer_usage SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_index_bloat SET SCHEMA collect;
ALTER TABLE IF EXISTS public.pg_cpu_utilization SET SCHEMA collect;
...
-- ===BATCH=== V80 collection-log-fanout-rollup
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (80, 'collection-log-fanout-rollup', now()::timestamp);
-- ===BATCH=== V81 tempdb-max-size
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (81, 'tempdb-max-size', now()::timestamp);
-- ===BATCH=== V82 server-engine-kind

ALTER TABLE collect.servers
    ADD COLUMN IF NOT EXISTS engine_kind text;
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (82, 'server-engine-kind', now()::timestamp);
-- ===BATCH=== V83 pg-database-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (83, 'pg-database-stats', now()::timestamp);
-- ===BATCH=== V84 pg-index-usage-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (84, 'pg-index-usage-stats', now()::timestamp);
-- ===BATCH=== V85 pg-table-bloat-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (85, 'pg-table-bloat-stats', now()::timestamp);
-- ===BATCH=== V86 pg-session-states
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (86, 'pg-session-states', now()::timestamp);
-- ===BATCH=== V87 pg-plan-capture-readiness
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (87, 'pg-plan-capture-readiness', now()::timestamp);
-- ===BATCH=== V88 pg-write-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (88, 'pg-write-stats', now()::timestamp);
-- ===BATCH=== V89 pg-extension-availability
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (89, 'pg-extension-availability', now()::timestamp);
-- ===BATCH=== V90 pg-lock-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (90, 'pg-lock-stats', now()::timestamp);
-- ===BATCH=== V91 pg-column-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (91, 'pg-column-stats', now()::timestamp);
-- ===BATCH=== V92 pg-replication-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (92, 'pg-replication-stats', now()::timestamp);
-- ===BATCH=== V93 pg-buffer-usage
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (93, 'pg-buffer-usage', now()::timestamp);
-- ===BATCH=== V94 pg-index-bloat
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (94, 'pg-index-bloat', now()::timestamp);
-- ===BATCH=== V95 pg-per-database-attribution
...
ALTER TABLE collect.pg_extension_availability
    ADD COLUMN IF NOT EXISTS database_name text;
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (95, 'pg-per-database-attribution', now()::timestamp);
-- ===BATCH=== V96 pg-wait-sampling
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (96, 'pg-wait-sampling', now()::timestamp);
-- ===BATCH=== V97 pg-kernel-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (97, 'pg-kernel-stats', now()::timestamp);
-- ===BATCH=== V98 pg-predicate-stats
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (98, 'pg-predicate-stats', now()::timestamp);
-- ===BATCH=== V99 pg-plan-capture
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (99, 'pg-plan-capture', now()::timestamp);
-- ===BATCH=== V100 pg-major-version

ALTER TABLE collect.servers
    ADD COLUMN IF NOT EXISTS postgres_major_version integer;
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (100, 'pg-major-version', now()::timestamp);
-- ===BATCH=== V101 pg18-io-bytes
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (101, 'pg18-io-bytes', now()::timestamp);
-- ===BATCH=== V102 pg-server-config
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (102, 'pg-server-config', now()::timestamp);
-- ===BATCH=== V103 pg-deadlocks
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (103, 'pg-deadlocks', now()::timestamp);
-- ===BATCH=== V104 pg-deadlock-identity-index

CREATE INDEX IF NOT EXISTS idx_pg_deadlocks_identity
    ON collect.pg_deadlocks(server_id, deadlock_hash);
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (104, 'pg-deadlock-identity-index', now()::timestamp);
-- ===BATCH=== V105 collector-cost
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (105, 'collector-cost', now()::timestamp);
-- ===BATCH=== V106 pg-cpu-utilization
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (106, 'pg-cpu-utilization', now()::timestamp);
-- ===BATCH=== V107 plan-force-actions
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (107, 'plan-force-actions', now()::timestamp);
-- ===BATCH=== V108 collection-log-phase-split
...
CREATE OR REPLACE VIEW collect.v_collection_log AS SELECT * FROM collect.collection_log;
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (108, 'collection-log-phase-split', now()::timestamp);
-- ===BATCH=== V109 collection-log-drain-forensics
...
CREATE OR REPLACE VIEW collect.v_collection_log AS SELECT * FROM collect.collection_log;
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (109, 'collection-log-drain-forensics', now()::timestamp);
-- ===BATCH=== V110 collection-log-fetch-phase-sums
...
CREATE OR REPLACE VIEW collect.v_collection_log AS SELECT * FROM collect.collection_log;
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (110, 'collection-log-fetch-phase-sums', now()::timestamp);
-- ===BATCH=== V111 store-log-self-monitoring
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (111, 'store-log-self-monitoring', now()::timestamp);
-- ===BATCH=== V112 collector-stall-wait-probes
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (112, 'collector-stall-wait-probes', now()::timestamp);
-- ===BATCH=== V113 remediation-credential-and-actor
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (113, 'remediation-credential-and-actor', now()::timestamp);
-- ===BATCH=== V114 pg-index-bloat-estimate-columns
...
INSERT INTO darling_schema_version (version, name, applied_at) VALUES (114, 'pg-index-bloat-estimate-columns', now()::timestamp);
