...
/// <summary>
/// #3898 D1 head pins for the "SqlTail" lane's sixth drop: <c>get_plan_corrections</c>, a twin on both products
/// (D6) whose original description was already byte-identical on Darling and Lite, so its tail is too. No D4
/// removals: the original text carried no issue references or anecdotes. Follows the pattern in
/// <see cref="McpToolGuideHeadsHealthParserTests"/>.
/// </summary>
