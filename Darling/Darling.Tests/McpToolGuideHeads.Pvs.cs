...
/// <summary>
/// #3898 D3 head pins for the "Pvs" family: <c>get_pvs_stats</c>, converted out of
/// <c>DarlingMcpPvsTools</c> (Darling) and its byte-identical Lite twin. Follows the pattern in
...
public sealed class McpToolGuideHeadsPvsTests
{
    ...
    /// <summary>The per-tool guardrail phrase each head must state. The pct_of_database rule names both null
