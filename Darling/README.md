...
```
  [PASS] aurora-writer: PostgreSQL 17 (server_version_num 170007), writer, Aurora — all 27 PostgreSQL collectors apply
  [PASS] aurora-reader: PostgreSQL 17 (server_version_num 170007), reader (in recovery), Aurora — 23 of 27 PostgreSQL collectors apply (skipped: pg_autovacuum_stats, pg_index_bloat, pg_index_usage_stats, pg_table_bloat_stats)
  [PASS] selfhosted:    PostgreSQL 15 (server_version_num 150012), reader (in recovery), not Aurora — 20 of 27 PostgreSQL collectors apply (skipped: pg_autovacuum_stats, pg_cpu_utilization, pg_index_bloat, pg_index_usage_stats, pg_io_stats, pg_table_bloat_stats, pg_wait_stats)
```
