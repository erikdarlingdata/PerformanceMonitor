...
| **TempDB Space**, **Volume Free Space**, **Long-Running / Failed Agent Job** | Yes | — | SQL-only by construction (tempdb, host volumes via `sys.dm_os_volume_stats`, SQL Agent). |
