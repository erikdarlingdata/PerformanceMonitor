...
namespace PerformanceMonitorDashboard
{
    public partial class ServerTab : UserControl
    {
        ...
        /* Re-entrancy latch for the Ctrl+V plan-paste handler (#2870). #2837's async clipboard retry keeps the UI
           ...
           incidentally serialized input, so a HELD Ctrl+V (OS key-repeat) could put several reads in flight at
           once and open several "Pasted Plan" tabs. While a paste is running the repeat is dropped (its key is
           still claimed via e.Handled). */
