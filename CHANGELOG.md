...
- **Plan-force journal reads no longer return pre-#4326 exception text** ([#4363]) - Both plan-force journal reads now replace exception text written before #4326 with a fixed sentence; evidence lines written after #4326 are returned unchanged.
